export interface QuotaRecord {
  ...
  validateComp2?: boolean; // Explicit override for whether Component 2 should be validated
}
...
export interface V3DisplayLabels {
  primary: string;
...
export const DEFAULT_V3_DISPLAY_LABELS: V3DisplayLabels = {
  primary: 'Y1',
  primarySecondary: 'Y2&Y3',
  secondary: 'C2:Y1',
  secondarySecondary: 'C2:Y2&Y3',
};
