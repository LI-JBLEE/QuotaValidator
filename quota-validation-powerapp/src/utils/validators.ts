...
export function runValidation(
  ...
  for (const rec of targetRecords) {
    ...
    const shouldValidateComp2 = rec.validateComp2 ?? (rec.dualMetric.toUpperCase() === 'DMC');
    const hasComp2 = shouldValidateComp2 && rec.monthlyQuotasComp2 !== null;
    const hasComp2Y2Y3 = shouldValidateComp2 && rec.monthlyQuotasComp2Y2Y3 !== null;
